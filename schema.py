...
class FinancialTransactionRow(BaseModel):
    ...
    reference_or_cheque_no: Optional[str] = Field(default=None, description="Reference or cheque number, if available.")
    description: str = Field(description="Detailed description of the transaction.")
    withdrawal_amount: Optional[float] = Field(default=None, description="The amount withdrawn (debit), if applicable.")
    credit_amount: Optional[float] = Field(default=None, description="The amount credited, if applicable.")
